...
- **Current artifact:** `README.md` containing scene draft content.
- **Current objective:** maintain a clean, navigable wiki summarizing and indexing the repo content.
...
1. The wiki should describe, not replace, the original scene text.
2. Scene text remains the source of truth; wiki pages should be regenerated/updated from it.
3. New pages should be cross-linked through this index and character/entity pages.
